...
urlpatterns = [
    ...
    path('reporte-total-compras/', ReporteTotaldeCompras.as_view({'get': 'list',
                                                                  'post': 'create'}), name='reporte-compras-total'),
    path('reporte-total-ventas/', ReporteTotaldeVentas.as_view({'get': 'list',
                                                                  'post': 'create'}), name='reporte-compras-total'),
    path('reporte-mejor-vendedor/', ReporteVendedorMayorVenta.as_view({'get': 'list',
                                                                  'post': 'create'}), name='reporte-compras-total'),
    path('reporte-cantidad-articulos-vendidos/', ReporteArticulosMasVendidosSql.as_view({'get': 'list',
                                                                  'post': 'create'}), name='reporte-compras-total'),
